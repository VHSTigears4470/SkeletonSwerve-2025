...
public final class Constants {
  ...
  public static class SwerveTurnConstants {
    ...
    // PID Values
    public static final double P_BACK_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 2 : 0;//0.885 : 0.28;
    public static final double P_FRONT_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 2 : 0;//0.87 : 0.267;
    public static final double P_FRONT_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 2 : 0;//0.89 : 0.36;
    public static final double P_BACK_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 2 : 0;//0.85 : 0.366;

    public static final double I_BACK_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.3 : 0;
    public static final double I_FRONT_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.3 : 0;
    public static final double I_FRONT_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.3 : 0;
    public static final double I_BACK_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.3 : 0;

    public static final double D_BACK_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.11 : 0;
    public static final double D_FRONT_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.1 : 0;
    public static final double D_FRONT_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.115 : 0;
    public static final double D_BACK_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0 : 0;//0.1 : 0;

    public static final double STATIC_BACK_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0.15 : 0.0;
    public static final double STATIC_FRONT_LEFT_TURN = DebuggingConstants.IS_IN_AIR ? 0.17 : 0.0; //
    public static final double STATIC_FRONT_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0.15 : 0.0;
    public static final double STATIC_BACK_RIGHT_TURN = DebuggingConstants.IS_IN_AIR ? 0.17 : 0.0; //
